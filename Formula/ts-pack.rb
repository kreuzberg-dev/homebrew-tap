...
class TsPack < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "e17982cd8d744d90588310f21e02fee40559896f192a8d331bcbaf20f0708d16"
    end

    on_intel do
      url "https://github.com/kreuzberg-dev/tree-sitter-language-pack/releases/download/v#{version}/ts-pack-macos-x86_64.tar.gz"
      sha256 "2bda4ec55180a8158f31681201a83af4ab45498502b7a10b9ff650e26f9f313d"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "8431edd54973e5b81f0da66e14676c85061671c1d53d22e70f9e13a1eb233ecd"
    end

    on_intel do
      url "https://github.com/kreuzberg-dev/tree-sitter-language-pack/releases/download/v#{version}/ts-pack-linux-x86_64.tar.gz"
      sha256 "3f7cd17135831e6a5c86d2a22d4f0df6a9c4bc83b4288be7bd0a47ec617d9cd8"
    end
  end
